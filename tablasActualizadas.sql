...
--
ALTER TABLE `articulo_revisor`
  ADD CONSTRAINT `FK_ID_ARTICULO_TO_REVISOR` FOREIGN KEY (`ID_ARTICULO`) REFERENCES `articulo` (`ID`),
  ADD CONSTRAINT `FK_ID_REVISOR_TO_ARTICULO` FOREIGN KEY (`ID_REVISOR`) REFERENCES `revisor` (`ID`);

--
-- Filtros para la tabla `autor_participante`
--
ALTER TABLE `autor_participante`
  ADD CONSTRAINT `FK_ID_ARTICULO` FOREIGN KEY (`ID_ARTICULO`) REFERENCES `articulo` (`ID`),
...
--
ALTER TABLE `especialidad_agregada`
  ADD CONSTRAINT `FK_ESPECIALIDAD_EXTRA` FOREIGN KEY (`ESPECIALIDAD_EXTRA`) REFERENCES `topico_especialidad` (`NOMBRE`),
  ADD CONSTRAINT `FK_ID_REVISOR` FOREIGN KEY (`ID_REVISOR`) REFERENCES `revisor` (`ID`);

--
-- Filtros para la tabla `jefe_comite`
--
ALTER TABLE `jefe_comite`
  ADD CONSTRAINT `FK_rut_jefe_revisor` FOREIGN KEY (`RUT`) REFERENCES `revisor` (`RUT`);
...
--
ALTER TABLE `topicos_extra`
  ADD CONSTRAINT `FK_ID_ARTICULO_TO_TOPICO` FOREIGN KEY (`ID_ARTICULO`) REFERENCES `articulo` (`ID`),
  ADD CONSTRAINT `FK_TOPICO_EXTRA` FOREIGN KEY (`TOPICO_EXTRA`) REFERENCES `topico_especialidad` (`NOMBRE`);
COMMIT;
